...
reg add "HKLM\SOFTWARE\Policies\Microsoft\OneDrive" /v KFMBlockOptInWithWizard /t REG_DWORD /d 1 /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\OneDrive" /v KFMBlockSilentOptIn /t REG_DWORD /d 1 /f
