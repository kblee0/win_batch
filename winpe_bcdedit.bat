...
bcdedit /set {ramdiskoptions} ramdisksdipath \img\boot.sdi
...
bcdedit /set %GUID% device ramdisk=[D:]\img\boot.wim,{ramdiskoptions}
bcdedit /set %GUID% path \windows\system32\winload.efi
bcdedit /set %GUID% description "Windows PE"
bcdedit /set %GUID% locale "ko-kr"
bcdedit /set %GUID% osdevice ramdisk=[D:]\img\boot.wim,{ramdiskoptions}
